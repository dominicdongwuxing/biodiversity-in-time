...
\begin{figure}[h]
	\centering
	\subfigure[The animal fossils identified under each phylum is ranked by amount in descending order and the top 5 phylums are shown. ]{\includegraphics[width=0.45\textwidth]{figures/result/animal_phylums}\label{fig:animal_phylum}} 
	\hfill
...
\begin{figure}[h]
	\centering
	\subfigure[The distribution of taxonomic ranks on which relocated animal fossils are identified. When a fossil has taxonomic information on lower ranks but lacking names on least one of the higher ranks, it is relocated to the rank before the first missing name. ]{\includegraphics[width=0.45\textwidth]{figures/result/animal_relocate}\label{fig:animal_relocate}} 
	\hfill
...
\begin{figure}[h]
	...
	\caption{The change in locations of Dictoyopteridiales fossils existed during Permian through time. The geological locations of the same fossils are tracked through time at an interval of 100 million years, in order to view how fossils move along with continental drifts. It is easy to notice that green marked fossils (under the genus of Glossopteris) inhabited together during their life time, however, their fossil locations separated in more recent times as a result of tectonic shift.}
	\label{fig:plant}
\end{figure}
%=====================================================================
\chapter{Conclusion} \label{chp:conclusion}
%=====================================================================
A complete data workflow is practiced and the new map and tree. It's good because it gives a more holistic view. It gives the freedom to check individual nodes and their locations.

\section{Limitations and Future Work}
relating to another dataset 
the performance issue
the styling 
the missing nodes
the special events
the other information like weather and oxygen
the map can be earlier 
%=====================================================================
