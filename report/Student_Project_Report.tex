...
\begin{titlepage}
	...
	\vspace{0.5cm}
	\Huge
	{\bf \textsf{A visualization of biodiversity through time}}
...
\begin{itemize}
	\item Introduction
		\begin{itemize}
		\item Visualization of biodiversity data for general public
		\item Current gap in biodiversity visualization 
		\item Aim of the thesis
		\item Thesis structure
		\end{itemize}

	\item Current biodiversity visualization and problems

	\item Problem statement
		\begin{itemize}
		\item Need tree data
		\item Need fossil data
		\item Need map data and transfer the location
		\end{itemize}
	...
	\item Technical solution
		...
		\item Data processing stage
			\begin{itemize}
			\item building of tree from PBDB data
			\item building of tree from Wiki data
			\item reconstructing fossil point positions 
			\end{itemize}
		\item Web development stage
			\begin{itemize}
			\item Data queries for tree, and for fossil points and locations
			\item Visualization of tree, computation of arc angles
			\end{itemize}
		\end{itemize}

	\item Implementation
		\begin{itemize}
		\item Data processing stage stacks
		\item Web development stage stacks
		\end{itemize}
	...
	\item Results
		...
		\item Data analysis
			\begin{itemize}
			\item PBDB tree data
			\item PBDB fossil data
			\item Wiki species tree data
			\end{itemize}
		\item Data visualization 
			\begin{itemize}
			\item Time selector component
				\begin{itemize}
				\item Stand-alone functionality
				\item Interactive functionality with map and tree
				\end{itemize}
			\item Map component
				\begin{itemize}
				\item Stand-alone functionality
				\item Interactive functionality with tree
				\end{itemize}
			\item Tree component
				\begin{itemize}
				\item Stand-alone functionality
				\item Interactive functionality with map
				\end{itemize}
			\end{itemize}
\end{itemize}
...
\smallskip
\noindent
[NC]  Krzysztof Niski and J.蔇. Cohen. Tile-based lod for the parallel age. In {\em Proceedings IEEE Visualization Conference (IEEE Vis�10)}, volume�13 of {\em IEEE TVCG journal}, page 1352. IEEE, Computer Society Press.
...
\smallskip
\noindent
[NC07]  Krzysztof Niski and Jonathan蔇. Cohen. Tile-based LOD for the parallel age. {\em IEEE Transactions on Visualization and Computer Graphics}, 13(6):1352�1359, November/December 2007.
